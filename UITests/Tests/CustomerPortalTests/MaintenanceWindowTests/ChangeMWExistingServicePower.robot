...
Documentation    ${TOPOLOGY_SHORT_NAME_DICT}[${TOPOLOGY}]: change Maintenance window for an existing service test for Power tier user
...
ChangeMWExistingServicePower
    ...
    ServiceDetailsKeywords.Change 'Maintenance window' field value    ${MAINTENANCE_WINDOW_CHANGED}
    ServiceDetailsKeywords.Compare new 'Date and Time' field value with the applied new maintenance window
