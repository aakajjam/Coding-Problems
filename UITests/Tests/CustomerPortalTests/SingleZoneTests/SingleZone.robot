...
Documentation    ${TOPOLOGY_SHORT_NAME_DICT}[${TOPOLOGY}] CRUD + Single Zone
Resource         ../../../Resources/Keywords/Utils/CommonKeywords.robot
Resource         ../../../Resources/Keywords/Utils/ConnectToDatabase.robot
Resource         ../../../Resources/Keywords/Utils/FeatureFlags.robot
...
#    FeatureFlags.Feature flag 'Single Zone' condition
    ...
    LaunchServiceDetailsKeywords.Select Single Zone checkbox
    ...
    ServicesDashboardkeywords.Validate single zone is displayed on the service's card    ${REGION}
